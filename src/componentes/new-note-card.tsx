                  ...
                  <div className='flex flex-1 flex-col gap-3 p-5'>   
                     ...
                     {shouldShowOnboarding ? (
                      ...
                      <p className='text-slate-300'>
                        ...
                        className='font-medium text-lime-400 hover:underline'>gravando uma nota</button> em áudio ou se preferir <button onClick={handleStartEditor} type='button' className='font-medium text-lime-400 hover:underline'>utilize apenas texto.</button> 
                      </p>  
                    ) : (
                      <textarea
